...
const LONG_RANGE: Gun[] = [
  {
    ...
    rank: 'Long Range',
    rankNum: 1,
    image: 'https://img.wzstats.gg/mk78/public',
    attachments: [
  ...
  },
  {
    ...
    rank: 'Long Range',
    rankNum: 2,
    image: 'https://img.wzstats.gg/voyak-kt-3/public',
    attachments: [
      { slot: 'Muzzle',   name: 'Monolithic Suppressor' },
...
const SHORT_RANGE: Gun[] = [
  {
    ...
    rank: 'Close Range',
    rankNum: 1,
    image: 'https://img.wzstats.gg/carbon-57/public',
    attachments: [
      { slot: 'Barrel',      name: '14" Rockleigh Barrel' },
      { slot: 'Stock',       name: 'Hammer Platoon Pad' },
  ...
  },
  {
    ...
    rank: 'Close Range',
    rankNum: 2,
    image: 'https://img.wzstats.gg/mpc-25/public',
    attachments: [
      { slot: 'Muzzle',     name: 'K&S Compensator' },
      { slot: 'Stock',      name: 'K-1 Pedal Stock' },
      { slot: 'Underbarrel',name: 'Zero Shift Handstop' },
      { slot: 'Magazine',   name: 'MPC Overload Drum' },
      { slot: 'Rear Grip',  name: 'Magnate Grip' },
    ],
    updatedAt: 'Jun 7, 2026',
  },
  {
    ...
    rank: 'Close Range',
    rankNum: 3,
    image: 'https://img.wzstats.gg/dravec-45/public',
    attachments: [
      { slot: 'Muzzle',    name: 'Bowen .45 Suppressor' },
      { slot: 'Barrel',    name: '19" EAM Horizon Barrel' },
      { slot: 'Stock',     name: 'Serval Q-Step Stock' },
      { slot: 'Magazine',  name: 'Gator Extended Mag' },
      { slot: 'Rear Grip', name: 'Herald-Z1 Grip' },
    ],
    updatedAt: 'Jun 7, 2026',
  },
];
