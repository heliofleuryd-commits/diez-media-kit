...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      {loading && <div className="text-[#71717A] text-sm">Loading…</div>}
      ...
      {noKV && !loading && (
        <div className="bg-yellow-950/40 border border-yellow-700/40 rounded-xl p-6 text-yellow-300 text-sm space-y-2">
          ...
          <p className="text-yellow-400/80">
            Go to Vercel dashboard → Storage → Create KV Database → connect to this project, then redeploy.
          </p>
        </div>
      )}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#18181B] border border-[#27272A] rounded-xl p-6">
              ...
              <div className="space-y-2">
                {data.topReferrers.length === 0 && <p className="text-[#52525B] text-sm">No data yet</p>}
            ...
            <div className="bg-[#18181B] border border-[#27272A] rounded-xl p-6">
              ...
              <div className="space-y-2">
                {data.topCountries.length === 0 && <p className="text-[#52525B] text-sm">No data yet</p>}
            ...
            <div className="bg-[#18181B] border border-[#27272A] rounded-xl p-6">
              ...
              <div className="space-y-2">
                {Object.entries(data.deviceCounts).length === 0 && <p className="text-[#52525B] text-sm">No data yet</p>}
            ...
            <div className="bg-[#18181B] border border-[#27272A] rounded-xl p-6">
              ...
              <div className="space-y-2">
                {Object.entries(data.ctaCounts).length === 0 && <p className="text-[#52525B] text-sm">No clicks tracked yet</p>}
